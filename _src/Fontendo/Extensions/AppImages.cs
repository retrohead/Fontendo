...
public class appImages
{
    ...
    public static BitmapImage? getImageFromResources(string resourcePath)
    {
        ...
        i = new imgType();
        i.path = resourcePath;
        i.img = new BitmapImage(new Uri("pack://application:,,,/Fontendo;component/Resources/" + resourcePath));
    ...
    public static bool exportResourceImageToFile(string resourcePath, string destPath)
    {
        ...
        try
        {
            using (System.IO.FileStream fileStream = new System.IO.FileStream(destPath, System.IO.FileMode.Create))
            {
                ...
                encoder.Frames.Add(BitmapFrame.Create(new Uri("pack://application:,,,/Fontendo;component/Resources/" + resourcePath)));
    ...
    public static Rectangle createSpecialIcon(MainWindow MainWindow, string iconName, int height, string brush)
    {
        ...
        rect.Fill = (Brush)MainWindow.FindResource(brush);
        rect.Height = height;
        return rect;
    }
    public static Grid createChangeableSpecialIcon(MainWindow MainWindow, string iconName, int height, string staticIconColorBrush)
    {
        ...
        Rectangle rect = appImages.createSpecialIcon(MainWindow, iconName, height, "ControlTextActive");
