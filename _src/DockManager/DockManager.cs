...
namespace DockManager
{
    ...
    {
        const double Step = 30; // pixels per tick
        ...
        public static void AnimateBorderClose(Border placeholder, double fromWidth = -1)
        {
            if (fromWidth == -1)
            ...
            placeholder.BeginAnimation(Border.WidthProperty, anim);
        }
        ...
        /// <summary>
         ...
         /// <param name="placeholder"></param>
         /// <param name="fromWidth"></param>
        public static void AnimateBorderOpen(Border placeholder, double toWidth)
        {
            if (toWidth == -1)
        ...
        public static void PopOut(UserControl control)
        {
            ...
            var floatWin = new CustomWindow(false)
            {
                Title = info.Name,
                Width = placeholderRect.Width + 50,
                Height = placeholderRect.Height < minHeight ? minHeight : placeholderRect.Height + 50,
        ...
        private static void FloatingWindow_LocationChanged(object? sender, EventArgs e)
        {
        ...
        {
            var mainHandle = new WindowInteropHelper(MainWindow.Self).Handle;
